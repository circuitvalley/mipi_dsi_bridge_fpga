...
{
    spi_registers_t volatile * spi = ((spi_registers_t *)(index));
    return (uint8_t)(spi->SPIxBUF & 0xFF);
}

PLIB_TEMPLATE uint32_t SPI_BufferRead_32( SPI_MODULE_ID index )
{
    spi_registers_t volatile * spi = ((spi_registers_t *)(index));
...
PLIB_TEMPLATE void SPI_BufferWrite_32( SPI_MODULE_ID index , uint32_t data )
{
    spi_registers_t volatile * spi = ((spi_registers_t *)(index));
    spi->SPIxBUF = data;
}
