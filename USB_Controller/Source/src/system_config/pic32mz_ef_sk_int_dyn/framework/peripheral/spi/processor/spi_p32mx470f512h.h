...
PLIB_INLINE_API uint32_t PLIB_SPI_BufferRead32(SPI_MODULE_ID index)
{
     return SPI_BufferRead_32(index);
}
...
PLIB_INLINE_API void PLIB_SPI_BufferWrite32(SPI_MODULE_ID index, uint32_t data)
{
     SPI_BufferWrite_32(index, data);
}
