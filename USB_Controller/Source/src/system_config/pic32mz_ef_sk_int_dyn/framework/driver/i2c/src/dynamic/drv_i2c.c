    ...
    if ( object == SYS_MODULE_OBJ_INVALID )
    {
        ...
        switch ( dObj->task )
        {
            ...
            case DRV_I2C_BUS_SILENT:
                ...
                if ( PLIB_I2C_TransmitterByteWasAcknowledged ( _DRV_I2C_PERIPHERAL_ID_GET ( i2cId ) ) || ( PLIB_I2C_TransmitterByteHasCompleted ( _DRV_I2C_PERIPHERAL_ID_GET ( i2cId ) )  &&  (!PLIB_I2C_TransmitterByteWasAcknowledged ( _DRV_I2C_PERIPHERAL_ID_GET ( i2cId ) )) ) )
                {
