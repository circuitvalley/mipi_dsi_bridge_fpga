...
static FATFS_VOLUME_OBJECT COHERENT_ALIGNED_16BIT FAFFSVolume[SYS_FS_VOLUME_NUMBER];
...
static FATFS_FILE_OBJECT COHERENT_ALIGNED_16BIT FATFSFileObject[SYS_FS_MAX_FILES];
